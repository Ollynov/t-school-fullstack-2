...
## Bonus: Let's integrate MongoDB [(database lesson)](https://github.com/Ollynov/FullStack-TSchool/blob/master/authentication-databases/lecture-notes-authentication.md)
